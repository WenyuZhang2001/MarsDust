...
#     plt.savefig(f'MAVEN_DustImpactSignal/model5_DustSignalPicture/{year}_Distribution/{year:0>4d}{month:0>2d}_LocalTime_Duration.jpg',dpi=400)
# plt.show()
...
# if len(year_month_dict.keys()) == 1:
#     year = int([year for year in year_month_dict.keys()][0])
#     plt.savefig(f'MAVEN_DustImpactSignal/model5_DustSignalPicture/{year}_Distribution/{year:0>4d}{month:0>2d}_LocalTime_ImpactRate_Distribution.jpg',dpi=400)
# plt.show()
...
# if len(year_month_dict.keys()) == 1:
#     year = int([year for year in year_month_dict.keys()][0])
#     plt.savefig(f'MAVEN_DustImpactSignal/model5_DustSignalPicture/{year}_Distribution/{year:0>4d}{month:0>2d}_LocalTime_ImpactRate_Numbers.jpg',dpi=400)
# plt.show()
...
if len(year_month_dict.keys()) == 1:
    year = int([year for year in year_month_dict.keys()][0])
    plt.savefig(f'MAVEN_DustImpactSignal/model5_DustSignalPicture/{year}_Distribution/{year:0>4d}{month:0>2d}_Height_Impact_Rate_Numbers.jpg',dpi=400)
plt.show()
...
# if len(year_month_dict.keys()) == 1:
#     year = int([year for year in year_month_dict.keys()][0])
#     plt.savefig(f'MAVEN_DustImpactSignal/model5_DustSignalPicture/{year}_Distribution/{year:0>4d}{month:0>2d}_LocalTime_ImpactNumber_Distribution.jpg',dpi=400)
# plt.show()
...
# if len(year_month_dict.keys()) == 1:
#     year = int([year for year in year_month_dict.keys()][0])
#     plt.savefig(f'MAVEN_DustImpactSignal/model5_DustSignalPicture/{year}_Distribution/{year:0>4d}{month:0>2d}_Latitude_ImpactRate_Distribution.jpg',dpi=400)
# plt.show()
...
# if len(year_month_dict.keys()) == 1:
#     year = int([year for year in year_month_dict.keys()][0])
#     plt.savefig(f'MAVEN_DustImpactSignal/model5_DustSignalPicture/{year}_Distribution/{year:0>4d}{month:0>2d}_Latitude_ImpactNumbers_Distribution.jpg',dpi=400)
# plt.show()
...
# if len(year_month_dict.keys()) == 1:
#     year = int([year for year in year_month_dict.keys()][0])
#     plt.savefig(f'MAVEN_DustImpactSignal/model5_DustSignalPicture/{year}_Distribution/{year:0>4d}{month:0>2d}_Latitude_Duration_Distribution.jpg',dpi=400)
# plt.show()